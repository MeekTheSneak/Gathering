 ...
 *
 * <p>Three: what a card is, what a deck is, and - on a deck a draft handed out - what it may
 * be built from. Everything else about a card is derived from a cache rather than stored on
 * the stack.
 */
