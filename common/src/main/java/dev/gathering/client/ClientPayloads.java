...
public final class ClientPayloads {
    ...
    public static final List<Route<?>> ROUTES = List.of(
            ...
            route(dev.gathering.network.TablePointingPayload.TYPE,
                    dev.gathering.network.TablePointingPayload.class,
                    ClientTablePointing::accept),
            ...
            route(dev.gathering.network.CollectionCardPayload.TYPE,
                    dev.gathering.network.CollectionCardPayload.class,
                    CardOverviewScreen::accept),
            route(dev.gathering.network.CollectionKeysPayload.TYPE,
                    dev.gathering.network.CollectionKeysPayload.class,
                    CollectionKeysScreen::accept),
            route(dev.gathering.network.JoinTablePromptPayload.TYPE,
                    dev.gathering.network.JoinTablePromptPayload.class,
                    JoinTableScreen::accept),
            route(dev.gathering.network.OpenDeckPickerPayload.TYPE,
                    dev.gathering.network.OpenDeckPickerPayload.class,
                    DeckPickerScreen::accept),
            route(dev.gathering.network.DeckNotLegalPayload.TYPE,
                    dev.gathering.network.DeckNotLegalPayload.class,
                    DeckNotLegalScreen::accept),
            route(dev.gathering.network.TableAwayPayload.TYPE,
                    dev.gathering.network.TableAwayPayload.class,
                    away -> ClientTableState.acceptAway(away.table(), away.seats())),
