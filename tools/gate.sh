...
for check in langcheck doccheck scenecheck plotcheck gesturecheck spritecheck statecheck savecheck runcheck texturecheck artcheck tablecheck keycheck; do
