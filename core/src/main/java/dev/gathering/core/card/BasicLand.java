 ...
 * colorless deck could not be given its own lands.
 * <p>Wastes is here because it is a basic land, prints as one, and is fetched and added by
 * the same effects. A list that is right about Magic until somebody plays colorless is not
 * right about Magic.
 */
public enum BasicLand {
     ...
     * already reads colors as, and the name is on the tooltip for anybody who wants it
     * spelled out.
     */
