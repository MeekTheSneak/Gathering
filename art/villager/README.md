...
- **`uv-overlay-64.png`** is the working one: 64x64, exactly the size of the texture, outlines
...
- **`uv-guide.png`** is the same map at ten times size with labels and a pixel grid, for
  reading rather than painting.
