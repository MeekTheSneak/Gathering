...
- **Deckboxes and binders:** storage blocks with search, sort by set/color/rarity, and deck assembly that validates card ownership (own the card to sleeve it, this is the one place collection mode adds a check that import mode does not have).
